...
const useShareableAccountState = () => {
...
const Login = () => {
    ...
    const {accountStatus,setAccountStatus,count}=useBetween(useShareableAccountState);
    ...
    const submitLogin = () => {
        ...
        login(payLoad)
            .then(response => {
                ...
                if(response.data.result.code===1020)setAccountStatus("Logout");
                //alert(JSON.stringify(response.data.result, null, 2));
                navigate("../");
            })
    ...
    return (
        <StyledDiv style={loginStyle}>
            ...
            <button onClick={handleSubmit(submitLogin)} style={buttonStyle}>Login</button>
...
const LoginButton=()=>{
    ...
    if(accessToken!=null)setAccountStatus("Logout")
    return (
        <StyledNavLink to="/login" onClick={() => {
            setAccessToken(null)
